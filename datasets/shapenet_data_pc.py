...
class Uniform15KPC(Dataset):
    def __init__(self, root_dir, subdirs, descriptions_df, tr_sample_size=10000, ###evtim
    ...
    def __getitem__(self, idx):
        ...
        #print('mid:', mid,'sid', sid, 'DESC', description)
        out = {
            'idx': idx,
            'train_points': tr_out,
            'test_points': te_out,
...
class ShapeNet15kPointClouds(Uniform15KPC):
    def __init__(self, root_dir="data/ShapeNetCore.v2.PC15k",
        ...
        super(ShapeNet15kPointClouds, self).__init__(
            root_dir, self.synset_ids, self.descriptions, ##evtim
